          ...
          <div className="flex items-center gap-2">
            <div className="flex text-xs">
              ...
              <button
                ...
                className={`px-2 py-1 border border-r-0 rounded-l-md flex items-center gap-1 ${sortBy === 'created_at'
              ...
              <button
                ...
                className={`px-2 py-1 border rounded-r-md flex items-center gap-1 ${sortBy === 'updated_at'
                  ? 'bg-blue-100 border-blue-300 text-blue-800'
                  : 'bg-slate-50 border-slate-200 text-slate-600 hover:bg-slate-100'
                  }`}
              >
          ...
          <div className="divide-y divide-slate-200">
            {currentTodos.length === 0 && !loading ? (
              ...
              currentTodos.map((todo) => (
                <div
                  key={todo.id}
                  className={`p-4 sm:p-5 transition-colors ${todo.completed ? 'bg-slate-50/80' : 'hover:bg-blue-50/20'
                    }`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <button
                      ...
                      className={`w-6 h-6 rounded-full flex-shrink-0 border mt-0.5 flex items-center justify-center transition-colors ${todo.completed
                      ...
                      {editingTodoId === todo.id ? (
                        ...
                        <div className="flex flex-col gap-3">
                          ...
                          <textarea
                            ...
                            value={formatContent(editNotesText)}
